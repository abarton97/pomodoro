...
function getButtons(e) {
    ...
    if (displayButton == 'START') {
        if (workStarted == true || breakStarted) {
...
const workOperators = document.querySelectorAll(".workOperators");
workOperators.forEach((workOperator) => workOperator.addEventListener("click", workUpDown));

const breakOperators = document.querySelectorAll(".breakOperators");
breakOperators.forEach((breakOperator) => breakOperator.addEventListener("click", breakUpDown));